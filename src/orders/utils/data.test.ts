    ...
    const unfulfilledLines: OrderLineWithMetadataFragment[] = [
      {
        ...
        thumbnail: {
          url: "http://localhost:8000/media/__sized__/products/weenspace-digital-03_2-thumbnail-255x255.png",
          __typename: "Image",
        },
        __typename: "OrderLine",
      },
      ...
      },
      {
        ...
        thumbnail: {
          url: "http://localhost:8000/media/__sized__/products/weenspacedemoproduct_cl_boot06_1-thumbnail-255x255.png",
          __typename: "Image",
        },
        __typename: "OrderLine",
      },
