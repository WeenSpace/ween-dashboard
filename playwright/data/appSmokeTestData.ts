...
export const APP_SMOKE_DATA: Record<string, AppSmokeEntry[]> = {
  v320: [
    {
      identifier: "app.weenspace.adyen_staging",
      name: "Adyen",
      heading: "Adyen",
      assertContent: expectText("No Adyen configurations added."),
    },
    {
      identifier: "weenspace.app.avatax_staging",
      name: "AvaTax",
      heading: "Configuration",
      assertContent: expectText("No configurations created yet"),
    },
    {
      identifier: "weenspace.app.cms2",
      name: "CMS",
      heading: "WeenSpace App CMS",
      assertContent: expectText("No configurations yet"),
    },
    {
      identifier: "weenspace.app.klaviyo",
      name: "Klaviyo",
      heading: "Configuration",
      assertContent: expectInputValue("PUBLIC_TOKEN", "test_token"),
    },
    {
      identifier: "weenspace.app.dummy.tax",
      name: "Dummy Tax",
      heading: "Welcome to WeenSpace Dummy Tax App",
      assertContent: expectText("See what your app can do"),
    },
    {
      identifier: "weenspace.app.search",
      name: "Search",
      heading: "Configuration",
      assertContent: expectText("DISABLED"),
    },
    {
      identifier: "weenspace.app.smtp",
      name: "SMTP",
      heading: "Configuration",
      assertContent: expectText("WeenSpace Cloud SMTP available"),
    },
  ],
  v321: [
    {
    ...
    {
      identifier: "weenspace.app.payment.np-atobarai",
      name: "NP Atobarai",
      heading: "Configuration",
      assertContent: expectText("No configurations found"),
    },
    {
      identifier: "weenspace.app.product-feed",
      name: "Product Feed",
      heading: "Configuration",
    ...
    {
      identifier: "weenspace.app.payment.stripe",
      name: "Stripe",
      heading: "Configuration",
      assertContent: expectText("No configurations found"),
    },
    {
      identifier: "weenspace.app.segment-v2",
      name: "Segment",
      heading: "Configuration",
      assertContent: expectText("DISABLED"),
    },
