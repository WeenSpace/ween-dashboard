...
test.skip("TC: WEENSPACE_83 Draft orders bulk delete #e2e #draft", async () => {
...
test.skip("TC: WEENSPACE_191 Refund products from the fully paid order #e2e #refunds", async () => {
...
test.skip("TC: WEENSPACE_192 Should create a manual refund with a custom amount #e2e #refunds", async () => {
...
for (const refund of orderRefunds) {
  test.skip(`TC: WEENSPACE_193 Update order with non-manual refund in ${refund.status} status #e2e #refunds`, async () => {
...
test(`TC: WEENSPACE_215 Inline discount is applied in a draft order #draft #discounts #e2e`, async () => {
  test.slow();
...
test(`TC: WEENSPACE_216 Order type discount is applied to a draft order #draft #discounts #e2e`, async () => {
  test.slow();
  await draftOrdersPage.goToDraftOrdersListView();
  await draftOrdersPage.clickCreateDraftOrderButton();
