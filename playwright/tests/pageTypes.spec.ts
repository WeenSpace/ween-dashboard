...
test("TC: WEENSPACE_187 As an admin user I can create page type #e2e #page-type", async ({ page }) => {
...
test("TC: WEENSPACE_188 As an admin user I can update page type#e2e #page-type", async ({ page }) => {
  const pageTypePage = new PageTypesPage(page);
